...
from meorphis_test_30 import MeorphisTest30, AsyncMeorphisTest30, APIResponseValidationError
from meorphis_test_30._client import MeorphisTest30, AsyncMeorphisTest30
from meorphis_test_30._models import BaseModel, FinalRequestOptions
from meorphis_test_30._constants import RAW_RESPONSE_HEADER
from meorphis_test_30._exceptions import (
    APIStatusError,
    APITimeoutError,
    MeorphisTest30Error,
    APIResponseValidationError,
)
from meorphis_test_30._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: MeorphisTest30 | AsyncMeorphisTest30) -> int:
...
class TestMeorphisTest30:
    client = MeorphisTest30(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "meorphis_test_30/_legacy_response.py",
                        "meorphis_test_30/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "meorphis_test_30/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MeorphisTest30Error):
            client2 = MeorphisTest30(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: MeorphisTest30) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(MEORPHIS_TEST_30_BASE_URL="http://localhost:5000/from/env"):
            client = MeorphisTest30(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(MEORPHIS_TEST_30_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                MeorphisTest30(api_key=api_key, _strict_response_validation=True, environment="production")
    ...
    def test_base_url_trailing_slash(self, client: MeorphisTest30) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: MeorphisTest30) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: MeorphisTest30) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = MeorphisTest30(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = MeorphisTest30(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("meorphis_test_30._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
...
class TestAsyncMeorphisTest30:
    client = AsyncMeorphisTest30(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MeorphisTest30Error):
            client2 = AsyncMeorphisTest30(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMeorphisTest30) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MEORPHIS_TEST_30_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMeorphisTest30(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(MEORPHIS_TEST_30_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                AsyncMeorphisTest30(api_key=api_key, _strict_response_validation=True, environment="production")
    ...
    def test_base_url_trailing_slash(self, client: AsyncMeorphisTest30) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMeorphisTest30) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMeorphisTest30) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMeorphisTest30(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncMeorphisTest30(base_url=base_url, api_key=api_key, _strict_response_validation=False)
