...
These methods return an [`APIResponse`](https://github.com/meorphis-test/test-repo-10/tree/main/src/meorphis_test_30/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/meorphis-test/test-repo-10/tree/main/src/meorphis_test_30/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
