# Meorphis Test 30 Python API library
...
These methods return an [`APIResponse`](https://github.com/meorphis-test/tree/main/src/meorphis_test_30/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/meorphis-test/tree/main/src/meorphis_test_30/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/meorphis-test/TEMP_meorphis-test-30-python/issues) with questions, bugs, or suggestions.
