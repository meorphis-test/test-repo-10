...
import * as AccountsAPI from 'meorphis-test-23/resources/accounts/accounts';
import * as CreditConfigurationAPI from 'meorphis-test-23/resources/accounts/credit-configuration';
